...
@keras_export('keras.optimizers.CustomOptimizer')
class CustomOptimizer(OptimizerV2):
    ...
    def set_weights(self, weights):
        ...
        super(CustomOptimizer, self).set_weights(weights)
...
@keras_export('keras.optimizers.NCustomOptimizer')
class NCustomOptimizer(OptimizerV2):
    ...
    def __init__(self, learning_rate=0.001, beta_1=0.9, beta_2=0.999,
                 ...
                 eta_min=0, eta_max=1, t_cur=0, name="NCustomOptimizer", **kwargs):
        if total_iterations > 1:
            weight_decays = _init_weight_decays(model, zero_penalties,
                                                weight_decays)
    ...
    def _prepare(self, var_list):
        ...
        return super(NCustomOptimizer, self)._prepare(var_list)
    ...
    def get_config(self):
        config = super(NCustomOptimizer, self).get_config()
        config.update({
            'learning_rate': self._serialize_hyperparameter('learning_rate'),
            'decay': self._serialize_hyperparameter('decay'),
            'beta_1': self._serialize_hyperparameter('beta_1'),
